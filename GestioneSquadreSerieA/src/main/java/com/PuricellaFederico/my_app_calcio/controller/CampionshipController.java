...
public class CampionshipController {
    ...
    @GetMapping("/{team}/{championShip}")// ritorno il cmapionato e squadre se true
    public ResponseEntity<ChampionshipInterfaceResponse> getTeam(@PathVariable Boolean team ,@PathVariable String championShip){
